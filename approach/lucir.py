...
class Appr(Inc_Learning_Appr):
    ...
    def pre_train_process(self, t, trn_loader):
        ...
        self.model.heads = CosineLinear(self.model.heads.in_features, self.model.heads.out_features)
        ...
        if t > 0:
            ...
            if self.less_forget:
                ...
                self.model.heads.sigma.requires_grad = True
            ...
            if self.adapt_lamda:
                ...
                self.lamda = self.lamb * math.sqrt((self.model.heads.out_features-self.classes_per_task)
                                                   / self.model.heads.out_features)
    ...
    def train_epoch(self, t, trn_loader):
        ...
        for images, targets in trn_loader:
            ...
            if (self.active_classes is not None):
                ...
                outputs['wsigma'] = outputs['wsigma'][:, class_entries]
                outputs['wosigma'] = outputs['wosigma'][:, class_entries]
                features = features[:, class_entries]
                if t > 0:
                    ref_outputs = ref_outputs[:, class_entries]
                    ref_features = ref_features[:, class_entries]
    ...
    def criterion(self, t, outputs, targets, ref_outputs=None, features=None, ref_features=None):
        ...
        if ref_outputs is None or ref_features is None:
            ...
            if self.less_forget:
                ...
                ref_outputs = ref_outputs['wosigma'].detach()
                old_scores = outputs['wosigma'][:-self.classes_per_task]
